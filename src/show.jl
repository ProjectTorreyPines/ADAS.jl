...
Base.show(io::IO, ::MIME"text/plain", file::adf11File) = print(io, "ADAS data | adf11 : $(basename(file.filepath)) ")
AbstractTrees.printnode(file::adf11File) = printstyled(io, basename(file.filepath); bold=true)
AbstractTrees.printnode(file::adf15File) = printstyled(io, basename(file.filepath); bold=true)
AbstractTrees.printnode(io::IO, a::Dict{String,adf11File}) = printstyled("┐")

AbstractTrees.printnode(io::IO, a::Dict{String,adf11File}) = printstyled("┐")
AbstractTrees.printnode(io::IO, a::Dict{String,Any}) = printstyled("┐")

AbstractTrees.printnode(io::IO, a::Dict{String,Dict{String,adf11File}}) = printstyled("┐")
AbstractTrees.printnode(io::IO, a::Dict{String,Dict{String,Dict{String,ADAS.adf11File}}}) = printstyled("┐")
AbstractTrees.printnode(file::adf11File) = printstyled(io, basename(file.filepath); bold=true)
